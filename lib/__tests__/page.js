...
describe('Page.write', () => {
  ...
  test('throws invalid operation error at create exists file path', async () => {
    const targetVueFile = `${tmpDir}/5.vue`;
    const targetMarkdownFile = `${tmpDir}/6.md`;
  ...
  test('throws invalid operation error at update not-exists file path', async () => {
    const targetVueFile = `${tmpDir}/7.vue`;
    const targetMarkdownFile = `${tmpDir}/8.md`;
