...
function postcssOptions(postcss, isProd) {
  const options = {
  ...
  if (postcss) {
    ...
    // }
    // if (postcss.cssVariables) {
    //   options.plugins.push(require('postcss-css-variables')());
    // }
    // if (postcss.calc) {
    //   options.plugins.push(require('postcss-calc'));
    // }
    if (postcss.nested) {
...
function baseConfig(isServer, isProd, isDebug, outDir, internalDir, inlineLimit, postcss, assetsDir) {
  ...
  function applyLoaders(rule, modules) {
    ...
    rule
      ...
      .options(postcssOptions(postcss, isProd));
  }
...
function createClientConfig(entryFilePath, isProd, isDebug, outDir, internalDir, inlineLimit, postcss, assetsDir) {
  const config = baseConfig(false, isProd, isDebug, outDir, internalDir, inlineLimit, postcss, assetsDir);
...
function createServerConfig(entryFilePath, isProd, isDebug, outDir, internalDir, inlineLimit, postcss, assetsDir) {
  const config = baseConfig(true, isProd, isDebug, outDir, internalDir, inlineLimit, postcss, assetsDir);
