...
function generateComponentsCode(masterPageName, components) {
  const componentsCode = [
    generateComponentCode(masterPageName ? `@internal/master-pages/${masterPageName}` : '@internal/default-master-page.vue', 'mp')
  ];
...
module.exports = function(src) {
  ...
  const componentsCode = generateComponentsCode(masterPageName, components);
